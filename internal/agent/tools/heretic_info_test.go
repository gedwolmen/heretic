...
import (
	...
	"github.com/gedwolmen/heretic/internal/lsp"
	"github.com/gedwolmen/heretic/internal/skills"
	"github.com/stretchr/testify/require"
)

func TestHereticInfo_MinimalConfig(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHereticInfo(cfg, nil, nil, nil, nil)
...
func TestHereticInfo_ConfigFiles(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(
		&config.Config{Providers: csync.NewMap[string, config.ProviderConfig]()},
		"/home/user/.config/heretic/heretic.json",
		"/project/.heretic/heretic.json",
	)
	output := buildHereticInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/heretic/heretic.json")
	require.Contains(t, output, "/project/.heretic/heretic.json")
}

func TestHereticInfo_Models(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Providers(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_DisabledProvidersOmitted(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_LSPStates(t *testing.T) {
	t.Parallel()
	...
	output := buildHereticInfo(cfg, mgr, nil, nil, nil)
...
func TestHereticInfo_MCPStates(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_YoloMode(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_AllowedTools(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_DisabledTools(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Options(t *testing.T) {
	t.Parallel()

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.heretic",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.heretic")
	require.Contains(t, output, "debug = true")
}

func TestHereticInfo_AutoSummarizeInversion(t *testing.T) {
	t.Parallel()
	...
	outputFalse := buildHereticInfo(cfgFalse, nil, nil, nil, nil)
	...
	outputTrue := buildHereticInfo(cfgTrue, nil, nil, nil, nil)
	require.Contains(t, outputTrue, "auto_summarize = true")
}

func TestHereticInfo_NoSecrets(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_DeterministicOrdering(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_EmptySectionsOmitted(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_ConfigStaleness_Clean(t *testing.T) {
	t.Parallel()

	dir := t.TempDir()
	configPath := filepath.Join(dir, "heretic.json")
	...
	output := buildHereticInfo(store, nil, nil, nil, nil)
...
func TestHereticInfo_ConfigStaleness_Dirty(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_ConfigStaleness_MissingPath(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Skills_NoSkills(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	t.Parallel()

	allSkills := []*skills.Skill{
		{Name: "go-doc", Builtin: false},
		{Name: "bash", Builtin: false},
		{Name: "heretic-config", Builtin: true},
	}
	activeSkills := allSkills

	tracker := skills.NewTracker(activeSkills)
	tracker.MarkLoaded("bash")
	tracker.MarkLoaded("heretic-config")

	cfg := config.NewTestStore(&config.Config{
		Providers: csync.NewMap[string, config.ProviderConfig](),
	})
	output := buildHereticInfo(cfg, nil, allSkills, activeSkills, tracker)
	require.Contains(t, output, "[skills]")
	require.Contains(t, output, "bash = user, loaded")
	require.Contains(t, output, "heretic-config = builtin, loaded")
	require.Contains(t, output, "go-doc = user, unloaded")
}

func TestHereticInfo_Skills_DisabledSkills(t *testing.T) {
	t.Parallel()
	...
	require.Contains(t, output, "heretic-config = builtin, unloaded")
	require.Contains(t, output, "image-convert = user, disabled")
}

func TestHereticInfo_Skills_Ordering(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Skills_BuiltinOrigin(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Hooks(t *testing.T) {
	t.Parallel()
...
func TestHereticInfo_Hooks_NoHooks(t *testing.T) {
	t.Parallel()
