...
const HereticInfoToolName = "heretic_info"

//go:embed heretic_info.md
var hereticInfoDescription string

type HereticInfoParams struct{}

func NewHereticInfoTool(
	...
	return fantasy.NewAgentTool(
		HereticInfoToolName,
		hereticInfoDescription,
		func(ctx context.Context, _ HereticInfoParams, _ fantasy.ToolCall) (fantasy.ToolResponse, error) {
			return fantasy.NewTextResponse(buildHereticInfo(cfg, lspManager, allSkills, activeSkills, skillTracker)), nil
		},
	)
}

func buildHereticInfo(cfg *config.ConfigStore, lspManager *lsp.Manager, allSkills []*skills.Skill, activeSkills []*skills.Skill, skillTracker *skills.Tracker) string {
