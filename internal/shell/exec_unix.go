...
// fully detached from Heretic's controlling terminal. This prevents shells
...
// It also prevents child processes from sending signals to Heretic's process
// group.
...
// from Heretic's session and controlling terminal.
//
