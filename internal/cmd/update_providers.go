...
heretic update-providers

# Update Catwalk providers from a custom URL
heretic update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
heretic update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
heretic update-providers embedded

# Update Hyper provider information
heretic update-providers --source=hyper

# Update Hyper from a custom URL
heretic update-providers --source=hyper https://hyper.example.com
`,
