...
import (
	...
	"github.com/gedwolmen/heretic/internal/oauth/hyper"
...
var loginCmd = &cobra.Command{
	Aliases: []string{"auth"},
	Use:     "login [platform]",
	Short:   "Login Heretic to a platform",
	Long: `Login Heretic to a specified platform.
...
heretic login copilot

# Force re-authentication even if already logged in
heretic login -f copilot
  `,
