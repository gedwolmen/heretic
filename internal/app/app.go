...
import (
	...
	"github.com/gedwolmen/heretic/internal/agent"
	...
	"github.com/gedwolmen/heretic/internal/shell"
	...
	"github.com/gedwolmen/heretic/internal/update"
...
type App struct {
	...
	// subscribers (notably `heretic run` in client/server mode) can
...
// for `heretic run`. A lossy fan-in here can drop the only terminal
