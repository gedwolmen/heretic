...
// LetterT renders the letter T in a stylized way. It takes a boolean
// that determines whether the top bar should be stretched.
...
// LetterI renders the letter I in a stylized way. It takes a boolean
// that determines whether the body should be stretched.
