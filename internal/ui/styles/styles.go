...
type Styles struct {
	...
	// Heretic's background. Defining them here keeps output readable and
	...
	Header struct {
		...
		LogoGradCanvas    lipgloss.Style // Canvas for the compact "HERETIC" gradient
		LogoGradFromColor color.Color    // "HERETIC" wordmark gradient start
		LogoGradToColor   color.Color    // "HERETIC" wordmark gradient end
	}
	...
	Logo struct {
		...
		SmallGradFromColor color.Color    // Small "Heretic" wordmark gradient start
		SmallGradToColor   color.Color    // Small "Heretic" wordmark gradient end
	}
