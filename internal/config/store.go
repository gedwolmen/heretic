...
import (
	...
	hyperp "github.com/gedwolmen/heretic/internal/agent/hyper"
...
type ConfigStore struct {
	...
	globalDataPath     string   // ~/.local/share/heretic/heretic.json
	workspacePath      string   // .heretic/heretic.json
